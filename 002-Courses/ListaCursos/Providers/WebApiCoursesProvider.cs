    ...
    public class WebApiCoursesProvider : ICoursesProvider
    {
        ...
        public async Task<ICollection<Course>> GetAllAsync()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var result = JsonSerializer.Deserialize<ICollection<Course>>(content, new JsonSerializerOptions() { PropertyNameCaseInsensitive = true });
        ...
        public async Task<Course> GetAsync(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var result = JsonSerializer.Deserialize<Course>(content, new JsonSerializerOptions() { PropertyNameCaseInsensitive = true });
